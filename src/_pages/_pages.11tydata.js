...
const { toAbsoluteImageUrl } = require('../../_11ty/filters/filters');
...
module.exports = {
  ...
  eleventyComputed: {
    ...
    ogImage: async (data) => {
      // inputPath will look like src/_page/yyyy-mm-dd-slug/ for a post located under src/_posts/yyyy-mm-dd-slug/index.md
